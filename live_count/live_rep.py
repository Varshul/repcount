...
if __name__ == '__main__':
	...
	layer0_w = 50
	layer0_h = 50
	layer1_w = int((layer0_w-4)/2)
	layer1_h = int((layer0_h-4)/2)
	layer2_w = int((layer1_w-2)/2)
	layer2_h = int((layer1_h-2)/2)
	layer3_w = int((layer2_w-2)/2)
	layer3_h = int((layer2_h-2)/2)
	...
	video_writer = cv2.VideoWriter("live_out.avi", fourcc, frame_rate, (640, 480))
